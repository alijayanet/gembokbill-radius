...
# IP Server GenieACS: 192.168.8.89:7547
# IP PPPoE: 192.168.10.0/24
# DNS Server: 192.168.8.89 (GenieACS server)
# Generated on: 26/9/2025, 03.43.52
...
/ip dns static add name="genieacs.local" address="192.168.8.89" ttl=300
/ip dns static add name="acs.local" address="192.168.8.89" ttl=300
/ip dns static add name="tr069.local" address="192.168.8.89" ttl=300
...
/ip dhcp-server network add address=192.168.10.0/24 gateway=192.168.10.1 \
    dns-server=192.168.8.89,8.8.8.8,8.8.4.4 domain=local
...
/ip firewall nat add chain=srcnat src-address=192.168.10.0/24 \
    dst-address=192.168.8.89 dst-port=7547 protocol=tcp \
    action=masquerade comment="tr069-genieacs"

# Allow TR069 traffic dari PPPoE users ke GenieACS server (HTTPS)
/ip firewall nat add chain=srcnat src-address=192.168.10.0/24 \
    dst-address=192.168.8.89 dst-port=7548 protocol=tcp \
...
/ip firewall filter add chain=forward src-address=192.168.10.0/24 \
    dst-address=192.168.8.89 dst-port=53 protocol=udp \
    action=accept comment="tr069-allow-dns"

# Allow DNS queries dari PPPoE users ke GenieACS server (TCP)
/ip firewall filter add chain=forward src-address=192.168.10.0/24 \
    dst-address=192.168.8.89 dst-port=53 protocol=tcp \
...
/ppp profile add name="genieacs-dns" local-address=192.168.10.1 \
    remote-address=pppoe-pool dns-server=192.168.8.89,8.8.8.8,8.8.4.4 \
...
:put "DNS Server: 192.168.8.89 (GenieACS)"
:put "PPPoE Range: 192.168.10.0/24"
:put "TR069 Port: 7547 (HTTP), 7548 (HTTPS)"
:put "Generated on: 26/9/2025, 03.43.52"
:put ""
:put "=== VERIFIKASI ==="
...
:put "2. DNS server diarahkan ke 192.168.8.89 (GenieACS)"
:put "3. TR069 traffic diizinkan ke port 7547/7548"
:put "4. ONU dapat berkomunikasi dengan GenieACS server"
:put ""
:put "=== SELESAI ==="

echo "Script DNS GenieACS telah dibuat dengan IP: 192.168.8.89!"
echo "Pastikan GenieACS server dapat diakses dari IP: 192.168.8.89"
